...
👉👉 En Casa Grande – administración de edificios estamos comprometidos a brindar información contribuyendo a que los copropietarios logren la vida segura y armónica que anhelan y adicional lograr que su propiedad se revalore en el tiempo.`,
  ...
  {
    id: "2",
    title: "Funciones del Presidente de la Junta de Propietarios",
    slug: "funciones-presidente-junta-propietarios",
    excerpt: "El presente documento detalla las funciones y responsabilidades del presidente de la junta de propietarios, una figura clave en la gestión y representación de la comunidad.",
    content: `# Funciones del Presidente de la Junta de Propietarios

El presidente de la junta de propietarios es una figura clave en la gestión y representación de la comunidad. A través de sus diversas tareas, asegura el buen funcionamiento y la defensa de los intereses comunes, actuando como enlace entre los propietarios y terceros.

## 1. Representación Legal
- El presidente tiene la responsabilidad de representar legalmente a la comunidad ante:
  - Terceros
  - Autoridades
  - Proveedores
  - Procesos judiciales
- Esta representación implica actuar en nombre y por cuenta de la comunidad
- Conlleva una gran responsabilidad en la defensa de los intereses de todos los propietarios

## 2. Convocatoria y Presidencia de Juntas
- Convocar y presidir las juntas de propietarios
- Asegurar que la convocatoria sea correcta
- Dirigir el desarrollo y cierre de las reuniones
- Garantizar un proceso transparente y efectivo en la toma de decisiones

## 3. Ejecución de Acuerdos
- Ejecutar los acuerdos adoptados en las juntas
- Velar por su cumplimiento
- Gestionar la administración diaria de la comunidad
- Colaborar con el administrador cuando exista
- Mantener el orden y la convivencia en el inmueble

## 4. Firma de Actas
- Firmar y cerrar las actas de las reuniones
- Asegurar que las actas sean documentos oficiales válidos
- Garantizar la transparencia y legalidad de los procesos
- Mantener un registro adecuado de todas las decisiones

## 5. Gestión de Conflictos y Sanciones
- Gestionar activamente los conflictos dentro de la comunidad
- Requerir el cese de actividades molestas
- Gestionar el pago de deudas
- Mantener la convivencia y el buen funcionamiento
- Resolver disputas entre propietarios
- Asegurar un ambiente armonioso

## 6. Negociación de Contratos
- Actuar como enlace principal con terceros
- Negociar contratos y acuerdos
- Velar por el beneficio de la comunidad
- Aplicar habilidades de negociación
- Conocer las necesidades y prioridades de la comunidad

---

### Conclusión

En Casa Grande – Administradora de Edificios sabemos que el presidente de la junta de propietarios es una figura fundamental que:
- Ostenta la representación legal de la comunidad
- Tiene facultades para actuar en juicio y fuera de él
- Centra su labor en la defensa de los intereses comunes
- Actúa bajo la supervisión de la junta de propietarios`,
    image: "/e1.webp",
    author: "Casa Grande",
    date: "20/04/2025",
    category: "Administración de Edificios",
  ...
  {
    id: "3",
    title: "VICIOS OCULTOS EN LA CONSTRUCCIÓN: ¿QUÉ SON Y CÓMO RECLAMAR?",
    slug: "vicios-ocultos-construccion",
    excerpt: "Los vicios ocultos en una construcción son defectos no visibles al momento de la entrega del inmueble, pero que afectan su funcionalidad o seguridad.",
    content: `# Vicios Ocultos en la Construcción: ¿Qué Son y Cómo Reclamar?

## Introducción

Los vicios ocultos en una construcción son defectos no visibles al momento de la entrega del inmueble que afectan su funcionalidad o seguridad. Este problema puede generar conflictos entre propietarios y constructores, especialmente en edificios multifamiliares o condominios en propiedad horizontal.

## ¿Qué son los Vicios Ocultos?

Son defectos de una edificación que no pueden detectarse a simple vista en el momento de la entrega. Pueden manifestarse como:

### Ejemplos Comunes:
- 🏠 Filtraciones en techos y paredes
- ⚡ Instalaciones eléctricas defectuosas
- 🏗️ Deficiencias en la cimentación o estructura
- 🚪 Mal funcionamiento de ascensores o puertas automáticas

## Base Legal en Perú

### Código Civil Peruano:
1. Artículo 1782: Responsabilidad del contratista por vicios ocultos
2. Artículo 1783: Derecho del comprador a exigir correcciones o reducción de precio
3. Artículo 1784: Responsabilidad del constructor por deterioro dentro de 5 años

### Reglamento Nacional de Edificaciones:
- Establece normas técnicas para asegurar calidad
- Previene fallas estructurales

## Procedimiento para Reclamar

### 1. Notificación Inicial
- ⏰ Plazo: 60 días desde detección
- 📝 Comunicación escrita a constructora
- 📋 Documentar evidencias

### 2. Inspección Técnica
- 👨‍🔧 Evaluación por perito especializado
- 📸 Documentación fotográfica
- 📊 Informe técnico detallado

### 3. Denuncia ante INDECOPI
- Si el constructor no responde
- Solicitar reparación o compensación
- Presentar evidencias recopiladas
...
### Caso Emblemático:
- Propietarios vs. Constructora por filtraciones
- Fallo favorable a propietarios
- Ordenaron reparaciones y compensación
- Sentó precedente para casos similares

## Conclusiones y Recomendaciones

### Si encuentras vicios ocultos:
1. Actúa dentro de plazos legales
2. Documenta todo detalladamente
3. Busca asesoría legal especializada
4. Presenta reclamo formal

### Prevención:
- Inspección detallada antes de recibir el inmueble
- Documentar estado inicial
- Guardar toda documentación relevante

---

¿Necesitas ayuda con la gestión de reclamos o inspección técnica? En Casa Grande estamos para asesorarte. 📞 Contáctanos para más información.`,
    image: "/e2.webp",
    author: "Casa Grande",
    date: "17/03/2025",
    category: "Administración de Edificios",
  ...
  {
    id: "4",
    title: "LA IMPORTANCIA DE LA JUNTA DE PROPIETARIOS EN UN EDIFICIO",
    slug: "importancia-junta-propietarios",
    excerpt: "La Junta de Propietarios es el órgano supremo de la administración de un edificio o condominio. Conoce sus funciones y por qué es crucial para la convivencia.",
    content: `# La Importancia de la Junta de Propietarios en un Edificio

## ¿Qué es la Junta de Propietarios?

La Junta de Propietarios es el órgano máximo de decisión en un edificio o condominio. Su correcto funcionamiento es esencial para garantizar una buena administración y convivencia entre los residentes. Es una organización conformada por todos los propietarios de las unidades inmobiliarias, regulada por la Ley N° 27157 y su reglamento.

## Base Legal 📜

- Ley N° 27157 - Ley de Regularización de Edificaciones
- Decreto Supremo N° 035-2006-VIVIENDA - Reglamento de la Ley
- Reglamento Interno del edificio o condominio

## Objetivos Principales 🎯

1. Velar por el correcto funcionamiento y mantenimiento del edificio
2. Administrar los bienes y servicios comunes
3. Garantizar la convivencia pacífica entre los residentes
4. Tomar decisiones sobre mejoras y reparaciones necesarias
5. Establecer y hacer cumplir el reglamento interno
...
- Fijar las cuotas de mantenimiento
- Contratar servicios necesarios
- Aprobar balances y estados financieros
...
### 3. Aspectos de Mantenimiento
- Programar mantenimientos preventivos
- Aprobar reparaciones necesarias
- Decidir sobre mejoras en áreas comunes
- Supervisar el estado del edificio

## Tipos de Reuniones 📅

### 1. Sesiones Ordinarias
- Se realizan al menos una vez al año
- Tratan temas programados y regulares
- Requieren convocatoria anticipada

### 2. Sesiones Extraordinarias
- Se convocan para temas urgentes
- Pueden ser solicitadas por los propietarios
- Tratan temas específicos y puntuales

## Quórum y Mayorías Necesarias 📊

- Primera convocatoria: 50% + 1 de los propietarios
- Segunda convocatoria: Los asistentes representan quórum
- Mayoría simple para decisiones regulares
- Mayoría calificada (2/3) para decisiones importantes

## Problemas Comunes y Cómo Evitarlos ⚠️

### 1. Falta de Participación
- Establecer multas por inasistencia
- Facilitar participación virtual
- Comunicar efectivamente la importancia

### 2. Morosidad en Cuotas
- Implementar sistema de cobranza efectivo
- Establecer fechas de pago claras
- Aplicar intereses moratorios

### 3. Conflictos entre Propietarios
- Tener reglamento claro
- Establecer mecanismos de resolución
- Mantener comunicación transparente

## Consejos para una Junta de Propietarios Efectiva 💡

1. Mantener registros actualizados
2. Comunicar decisiones oportunamente
3. Ser transparente en la gestión
4. Planificar reuniones con anticipación
5. Fomentar la participación activa

## Beneficios de una Junta de Propietarios Bien Organizada 🏆

✅ Mejor mantenimiento del edificio
...
¿Necesitas ayuda para organizar o mejorar tu Junta de Propietarios? En Casa Grande somos expertos en administración de edificios. ¡Contáctanos para asesorarte! 🌟`,
    image: "/e70.webp",
    author: "Casa Grande",
    date: "13/03/2025",
    category: "Administración de Edificios",
...
export default function BlogPage() {
  ...
  useEffect(() => {
    console.log("Blog page rendering with:", {
